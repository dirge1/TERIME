...
%---------------------------------------------------------------------------------------------------------------------------
%---------------------------------------------------------------------------------------------------------------------------
function [Best_rime_rate,Best_rime,Convergence_curve]=RIME_cross(N,Max_iter,lb,ub,dim,fobj,index)
    ...
    for i=1:N
        for j=1:dim
            ...
            if r1< 0.2
                ...
                newRimepop(i,j)=Best_rime(1,j)+W*(newRimepop(randi(N),j)-newRimepop(randi(N),j));
            end
