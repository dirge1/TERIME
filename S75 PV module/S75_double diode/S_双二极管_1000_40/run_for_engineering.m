                    ...
                    for F=1:length(U_m)
                        ...
                        for w=1:100
                            ...
                            for i=1:M
                                ...
                                [Best_score,Best_x,cg_curve]=RIME_differential_learning(nPop,Max_iter,lb,ub,dim,fobj,2);
                            ...
                            for o=1:O
                                ...
                                for i=1:N
                                    cho=v(randi([1, U]));
                                    Best_rime=Optimal_results{4,cho};
                                    p=0.2;
                                    % [Best_score,Best_x,cg_curve]=RIME_mutation3N(Best_rime,nPop,Max_iter,lb,ub,dim,fobj,2,p);
                                    [Best_score,Best_x,cg_curve]=RIME_cross3N(Best_rime,nPop,Max_iter,lb,ub,dim,fobj,2);
                                    Optimal_results{1,index}="RIME";
                                    Optimal_results{2,index}=cg_curve;
                                    Optimal_results{3,index}=Best_score;
                                    Optimal_results{4,index}=Best_x;
