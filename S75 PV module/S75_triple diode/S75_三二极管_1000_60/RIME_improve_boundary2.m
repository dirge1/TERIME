...
%---------------------------------------------------------------------------------------------------------------------------
%---------------------------------------------------------------------------------------------------------------------------
function [Best_rime_rate,Best_rime,Convergence_curve]=RIME_improve_boundary2(N,Max_iter,lb,ub,dim,fobj,index)
        ...
        for j=1:dim
            ...
            if r2<normalized_rime_rates(i)
                ...
                if r3<0.5
                    ...
                    newRimepop(i,j)=mutations(newRimepop(i,j),newRimepop(:,j),Best_rime(1,j),Lb(j),Ub(j),1,it,Max_iter,index,Best_rime_rate,j,0);
                end
            end
        end
    end
